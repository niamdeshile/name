          ...
          <el-form-item class="input" label="活动地点" prop="huodongdidian">
              <el-input v-model="ruleForm.huodongdidian" 
                placeholder="活动地点" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="报名文档" prop="baomingwendang">
          <file-upload
          tip="点击上传报名文档"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.baomingwendang?ruleForm.baomingwendang:''"
          @change="baomingwendangUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.baomingwendang" label="报名文档" prop="baomingwendang">
            <el-button type="text" size="small" @click="download(ruleForm.baomingwendang)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                                                                                                                                                                                                                  </el-row>
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.huodongjieshao" label="活动介绍" prop="huodongjieshao">
                    <span v-html="ruleForm.huodongjieshao"></span>
                                ...
                                <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="活动进展" prop="huodongjinzhan">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.huodongjinzhan" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.huodongjinzhan" label="活动进展" prop="huodongjinzhan">
                    <span v-html="ruleForm.huodongjinzhan"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	huodongdidian : false,
	baomingwendang : false,
	huodongjieshao : false,
	huodongjinzhan : false,
	sfsh : false,
	shhf : false,
	thumbsupnum : false,
	crazilynum : false,
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.huodongdidian = true;
            continue;
	            	            ...
	            	            if(o=='baomingwendang'){
            this.ruleForm.baomingwendang = obj[o];
	    this.ro.baomingwendang = true;
            continue;
          }
	            	            if(o=='huodongjieshao'){
	    ...
	    this.ro.huodongjieshao = true;
            continue;
	            	            ...
	            	            if(o=='huodongjinzhan'){
            this.ruleForm.huodongjinzhan = obj[o];
	    this.ro.huodongjinzhan = true;
            continue;
          }
	            	            	            	            if(o=='thumbsupnum'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `huanbaohuodong/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.huanbaohuodongCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    back() {
      ...
      this.parent.contentStyleChange();
				...
				this.addEditUploadStyleChange()
                                                                    ...
                                                                    baomingwendangUploadChange(fileUrls) {
                this.ruleForm.baomingwendang = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                                                    	addEditStyleChange() {
	  this.$nextTick(()=>{
