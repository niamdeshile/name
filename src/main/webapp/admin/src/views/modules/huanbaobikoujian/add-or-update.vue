          ...
          <el-form-item class="input" label="用户账号" prop="yonghuzhanghao">
              <el-input v-model="ruleForm.yonghuzhanghao" 
                placeholder="用户账号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="用户名称" prop="yonghumingcheng">
          <el-input v-model="ruleForm.yonghumingcheng" 
              placeholder="用户名称" clearable  :readonly="ro.yonghumingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="用户名称" prop="yonghumingcheng">
              <el-input v-model="ruleForm.yonghumingcheng" 
          ...
          <el-form-item class="input" label="手机" prop="shouji">
              <el-input v-model="ruleForm.shouji" 
                placeholder="手机" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="环保币" prop="huanbaobi">
          <el-input v-model="ruleForm.huanbaobi" 
              placeholder="环保币" clearable  :readonly="ro.huanbaobi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="环保币" prop="huanbaobi">
              <el-input v-model="ruleForm.huanbaobi" 
                placeholder="环保币" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.riqi" label="日期" prop="riqi">
              <el-input v-model="ruleForm.riqi" 
                placeholder="日期" readonly></el-input>
                                                                                ...
                                                                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="扣减原因" prop="koujianyuanyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="扣减原因"
                  v-model="ruleForm.koujianyuanyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.koujianyuanyin" label="扣减原因" prop="koujianyuanyin">
                    <span>{{ruleForm.koujianyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	yonghumingcheng : false,
	shouji : false,
	huanbaobi : false,
	koujianyuanyin : false,
	riqi : false,
      },
            ruleForm: {
                	        yonghuzhanghao: '',
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yonghuzhanghao = true;
            continue;
	            	            ...
	            	            if(o=='yonghumingcheng'){
            this.ruleForm.yonghumingcheng = obj[o];
	    this.ro.yonghumingcheng = true;
            continue;
          }
	            	            if(o=='shouji'){
	    ...
	    this.ro.shouji = true;
            continue;
	            	            ...
	            	            if(o=='huanbaobi'){
            this.ruleForm.huanbaobi = obj[o];
	    this.ro.huanbaobi = true;
            continue;
          }
	            	            if(o=='koujianyuanyin'){
            this.ruleForm.koujianyuanyin = obj[o];
	    this.ro.koujianyuanyin = true;
            continue;
          }
	            	            if(o=='riqi'){
	    ...
	    this.ro.riqi = true;
            continue;
                                                                        ...
                                                                        this.ruleForm.huanbaobi = 0
	this.ro.huanbaobi = false;
                                                      }
            // 获取用户信息
      this.$http({
    ...
    onSubmit() {
      ...
      obj.huanbaobi = obj.huanbaobi - this.ruleForm.huanbaobi
      if(obj.huanbaobi<0){
        this.$message.error("环保币不足");
        return
      }
      this.$http({
          url: `${table}/update`,
        ...
        if (valid) {
          this.$http({
            url: `huanbaobikoujian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.huanbaobikoujianCrossAddOrUpdateFlag = false;
                  this.parent.search();
