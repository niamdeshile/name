          ...
          <el-form-item class="input" label="项目名称" prop="xiangmumingcheng">
              <el-input v-model="ruleForm.xiangmumingcheng" 
                placeholder="项目名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="支持金额" prop="zhichijine">
          <el-input v-model="ruleForm.zhichijine" 
              placeholder="支持金额" clearable  :readonly="ro.zhichijine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="支持金额" prop="zhichijine">
              <el-input v-model="ruleForm.zhichijine" 
                placeholder="支持金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiangmumingcheng = true;
            continue;
	            	            ...
	            	            if(o=='zhichijine'){
            this.ruleForm.zhichijine = obj[o];
	    this.ro.zhichijine = true;
            continue;
          }
	            	            if(o=='yonghuzhanghao'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `zhongchouzhichi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhongchouzhichiCrossAddOrUpdateFlag = false;
                  this.parent.search();
