          ...
          <el-form-item class="input" label="商品类型" prop="shangpinleixing">
              <el-input v-model="ruleForm.shangpinleixing" 
                placeholder="商品类型" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所需环保币" prop="suoxuhuanbaobi">
          <el-input v-model="ruleForm.suoxuhuanbaobi" 
              placeholder="所需环保币" clearable  :readonly="ro.suoxuhuanbaobi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所需环保币" prop="suoxuhuanbaobi">
              <el-input v-model="ruleForm.suoxuhuanbaobi" 
                placeholder="所需环保币" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shangpinleixing = true;
            continue;
	            	            ...
	            	            if(o=='suoxuhuanbaobi'){
            this.ruleForm.suoxuhuanbaobi = obj[o];
	    this.ro.suoxuhuanbaobi = true;
            continue;
          }
	            	            if(o=='yonghuzhanghao'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shangpinduihuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shangpinduihuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
