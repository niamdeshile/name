          ...
          <el-form-item class="input" label="活动名称" prop="huodongmingcheng">
              <el-input v-model="ruleForm.huodongmingcheng" 
                placeholder="活动名称" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="报名表" prop="baomingbiao">
          <file-upload
          tip="点击上传报名表"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.baomingbiao?ruleForm.baomingbiao:''"
          @change="baomingbiaoUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.baomingbiao" label="报名表" prop="baomingbiao">
            <el-button type="text" size="small" @click="download(ruleForm.baomingbiao)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                                    <el-col :span="12">
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.huodongmingcheng = true;
            continue;
	            	            ...
	            	            if(o=='baomingbiao'){
            this.ruleForm.baomingbiao = obj[o];
	    this.ro.baomingbiao = true;
            continue;
          }
	            	            if(o=='yonghuzhanghao'){
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                            ...
                                                            baomingbiaoUploadChange(fileUrls) {
                this.ruleForm.baomingbiao = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                                                    	addEditStyleChange() {
	  this.$nextTick(()=>{
