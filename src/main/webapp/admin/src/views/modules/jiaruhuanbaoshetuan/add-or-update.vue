          ...
          <el-form-item class="input" label="手机" prop="shouji">
              <el-input v-model="ruleForm.shouji" 
                placeholder="手机" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="申请文档" prop="shenqingwendang">
          <file-upload
          tip="点击上传申请文档"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.shenqingwendang?ruleForm.shenqingwendang:''"
          @change="shenqingwendangUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.shenqingwendang" label="申请文档" prop="shenqingwendang">
            <el-button type="text" size="small" @click="download(ruleForm.shenqingwendang)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shouji = true;
            continue;
	            	            ...
	            	            if(o=='shenqingwendang'){
            this.ruleForm.shenqingwendang = obj[o];
	    this.ro.shenqingwendang = true;
            continue;
          }
	            	            if(o=='beizhu'){
        ...
        if (data && data.code === 0) {
          var json = data.data;
              		...
              		this.ruleForm.yonghuzhanghao = json.yonghuzhanghao
                                  		...
                                  		if(json.yonghumingcheng!=''&&json.yonghumingcheng){
              		this.ruleForm.yonghumingcheng = json.yonghumingcheng
		}
          ...
          this.$message.error(data.msg);
                                                                                ...
                                                                                // 多级联动参数
                                                                                                      info(id) {
      this.$http({
        url: `jiaruhuanbaoshetuan/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jiaruhuanbaoshetuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiaruhuanbaoshetuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                                                    ...
                                                                                    shenqingwendangUploadChange(fileUrls) {
                this.ruleForm.shenqingwendang = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                	addEditStyleChange() {
	  this.$nextTick(()=>{
