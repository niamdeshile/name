  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(25, 169, 123, 1);fontSize:28px;">江门环保公益网注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.yonghumingcheng" class="input" type="text" placeholder="用户名称">
			   </div>
			 </div> -->
			<el-form-item label="用户名称" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.yonghumingcheng" autocomplete="off" placeholder="用户名称" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='yonghu'" class="input-group">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱" type="text" />
																																	...
																																	<!-- <div v-if="tableName=='huanbaoshetuan'" class="input-group">
			   <div class="label">社团编号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.shetuanbianhao" class="input" type="text" placeholder="社团编号">
			   </div>
			 </div> -->
			<el-form-item label="社团编号" class="input" v-if="tableName=='huanbaoshetuan'">
			  <el-input v-model="ruleForm.shetuanbianhao" autocomplete="off" placeholder="社团编号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='huanbaoshetuan'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='huanbaoshetuan'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='huanbaoshetuan'" class="input-group">
			...
			<el-form-item label="社团名称" class="input" v-if="tableName=='huanbaoshetuan'">
			...
			<el-form-item label="负责人姓名" class="input" v-if="tableName=='huanbaoshetuan'">
			  <el-input v-model="ruleForm.fuzerenxingming" autocomplete="off" placeholder="负责人姓名" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='huanbaoshetuan'" class="input-group">
			   <div class="label">社团人数</div>
			   <div class="input-container">
			     <input v-model="ruleForm.shetuanrenshu" class="input" type="text" placeholder="社团人数">
			   </div>
			 </div> -->
			<el-form-item label="社团人数" class="input" v-if="tableName=='huanbaoshetuan'">
			  <el-input v-model="ruleForm.shetuanrenshu" autocomplete="off" placeholder="社团人数" type="text" />
			</el-form-item>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210116/1cec02de420545959de6d077f69986dc.jpg");
		height: 100vh;
